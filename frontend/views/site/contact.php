                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <button type="submit" class="btn btn_send" name="contact-button">Ugrat</button>                        </div>
                    </div>
                </div>
                </form>            </div>
            <div class="col-md-4 contact_info" style="background: #1273eb;">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-9">
                        ...
                        <p><a href="<?= $ownInfo->my_phone ?>" target="_blank" style="color:#fff;"><?= $ownInfo->my_phone ?></a><br></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-3 contact_icons">
                    ...
                    <div class="col-xs-9">
                        <h4>EMAIL</h4>
                                                <p> <a href="mailto:www.begleryoly.com" target="_blank" style="color:#fff"><?= $ownInfo->my_email ?><br></a></p>
                    </div>
                </div>
            </div>
        </div>
